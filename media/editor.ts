...
function attachToolbarToTopBar(): void {
  ...
  ensureToolbarSearchButton();
}

function ensureToolbarSearchButton(): void {
  if (toolbarElement.querySelector('[data-action="find"]')) {
    return;
  }

  const searchButton = document.createElement("button");
  searchButton.type = "button";
  searchButton.dataset.action = "find";
  searchButton.title = "Find";
  searchButton.setAttribute("aria-label", "Find");
  ...
  `;
  toolbarElement.prepend(searchButton);
}
